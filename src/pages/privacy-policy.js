  ...
  return (
    <Layout pageTitle="Terms of Use">
      ...
      <p>Last Updated: 16 May 2019</p>
        ...
        <p>We receive and store any information you knowingly provide to us when you publish content, fill any online forms on the Website, 
        {/* Added Start */}
          subscribe to our newsletter etc.
          {/* Added End */}
        You can choose not to provide us with certain information, but then you may not be able to take advantage of some of the Website's features. Users who are uncertain about what information is mandatory are welcome to contact us.</p>
        ...
        {/* Added Start */}
        <h2>Location Data</h2>
        <p>We may store and use location information (GPS Data) to improve and customise our services, if you give us permission to do so. You can disable it anytime through device settings.</p>
        {/* Added End */}
        ...
        {/* Added Start */}
          We may publically publish a report on trends or statistics about the behavior of visitors of this website.
          {/* Added End */}
        </p>
        ...
        <p>We may disclose information about you to our affiliates for the purpose of being able to offer you related or additional products and services. Any information relating to you that we provide to our affiliates will be treated by those affiliates in accordance with the terms of this Privacy Policy. 
        {/* Added Start */}
          We may also use affiliate links to earn a commission. 
          {/* Added End */}
        </p>
        ...
        We employ third party companies and services to provide the Service on our behalf. These third parties have access to your Personal Data governed by their privacy policy.

        <h3>Google Analytics</h3>
        <p>We use <a href="https://analytics.google.com/analytics/web/" target="_blank" rel="nofollow noopener noreferrer">Google Analytics</a> on our website to track traffic and to get statistical data provided by it. Please read Google Analytics Privacy Policy to understand there privacy practices.</p>

        <h3>MailChimp</h3>
        <p>We use <a href="https://mailchimp.com/" target="_blank" rel="nofollow noopener noreferrer">MailChimp</a> on our website to build subscription list, create campaign and other services provided by it. Please read Mail Chimp Privacy Policy to understand the handling of this data.</p>

        <h3>Disqus</h3>
        <p>We use <a href="https://disqus.com/" target="_blank" rel="nofollow noopener noreferrer">Disqus</a> on our website to allow users to comment and react on our artilces. Please read Disqus Privacy Policy to understand the handling of this data.</p>

        <h3>Subscribers</h3>
        <p>We use <a href="https://subscribers.com/" target="_blank" rel="nofollow noopener noreferrer">Subscribers</a> on our website for push Notifications. Please read Subscribers Privacy Policy to understand the handling of this data.</p> 
        {/* Added End */}
        ...
        <p>If you have any questions about this Policy, please <a href="https://www.facebook.com/arabicblog/" target="_blank" rel="nofollow noopener noreferrer">contact us</a>.</p>
      </Container>
    </Layout>
  );
}
